# Supplier.create!([{name: "Shoe Warehouse", email: "sw@gmail.com", phone_number: "222-3344"},
#   {name: "Accessories Now", email: "an@gmail.com", phone_number: "333-4433"}])




# Product.create!([
#   {name: "Dior", price: "300.0", description: "Christian Dior Handbag", total_inventory: nil},
#   {name: "Louis Vuitton", price: "900.0", description: "Louis Vuitton Patent Collection", total_inventory: nil},
#   {name: "Christian Louboutin", price: "775.0", description: "Pump", total_inventory: nil},
#   {name: "YSL", price: "700.0", description: "sandal", total_inventory: nil},
#   {name: "Celine", price: "700.0", description: "Handbag", total_inventory: nil},
#   {name: "Hermes", price: "400.0", description: "Silk Scarf Tri-tone", total_inventory: nil},
#   {name: "Tom Ford ", price: "800.0", description: "Trench", total_inventory: nil},
